							...
							<div class="col-12">
								<div class="card mb-4">
									<div class="card-block">
                                        <?php
                                            //Recogida de datos para guardar alumnos en la BD
                                            $nia = $_POST["nia"];
                                            $apellidosNombre = "'".$_POST["apellidosNombre"]."'";
                                            $correo = "'".$_POST["correo"]."'";
                                            $carnet = "'".$_POST["carnet"]."'";
                                            ...
                                            $query = "INSERT INTO alumnos (NIA,apellidos_nombre,correo, carnet,telefono,situacionLaboral,observaciones) VALUES
                                                      (".$nia.", ".$apellidosNombre.", ".$correo.", ".$carnet.", ".$telefono.", ".$situacionLaboral.", ".$observaciones.");";
                                            $objetoBBDD->consultarBD($query);

                                            if($objetoBBDD->filasAfectadas()==1)
                                            {
                                                //Una vez insertado los alumnos en la BD, insertamos las claves ajenas en la tabla alumnos_formacion
                                                $query1 = "INSERT INTO alumnos_formacion (NIA,idFormacion) VALUES (".$nia.", ".$requisito1.");";
                                                $objetoBBDD->consultarBD($query1);
                                                $query2 = "INSERT INTO alumnos_formacion (NIA,idFormacion) VALUES (".$nia.", ".$requisito2.");";
                                                $objetoBBDD->consultarBD($query2);
                                                if(isset($requisito3))
                                                {
                                                    $query3 = "INSERT INTO alumnos_formacion (NIA,idFormacion) VALUES (".$nia.", ".$requisito3.");";
                                                    $objetoBBDD->consultarBD($query3);
                                                }
                                                if(isset($requisito4))
                                                {
                                                    $query33 = "INSERT INTO alumnos_formacion (NIA,idFormacion) VALUES (".$nia.", ".$requisito4.");";
                                                    $objetoBBDD->consultarBD($query33);
                                                }
                                                if(isset($requisito5))
                                                {
                                                    $query333 = "INSERT INTO alumnos_formacion (NIA,idFormacion) VALUES (".$nia.", ".$requisito5.");";
                                                    $objetoBBDD->consultarBD($query333);
                                                }

                                                $query4 = "INSERT INTO alumnos_formacion (NIA,idFormacion) VALUES (".$nia.", ".$actitud1.");";
                                                $objetoBBDD->consultarBD($query4);
                                                $query5 = "INSERT INTO alumnos_formacion (NIA,idFormacion) VALUES (".$nia.", ".$actitud2.");";
                                                $objetoBBDD->consultarBD($query5);
                                                if(isset($actitud3))
                                                {
                                                    $query6 = "INSERT INTO alumnos_formacion (NIA,idFormacion) VALUES (".$nia.", ".$actitud3.");";
                                                    $objetoBBDD->consultarBD($query6);
                                                }
                                                echo '<div style="color:green;font-weight: bold">Éxito al dar de alta al alumno.</div><br>';
                                            }
                                            else
                                            {
                                                echo '<div style="color:red;font-weight: bold">Error al dar de alta al alumno.</div><br>';
                                            }
                                        echo '<a href="altaAlumnos.php"><button type="submit" class="btn btn-primary btn-md float-right">Volver</button></a>';
                                        ?>
									</div>
								</div>
							</div>
