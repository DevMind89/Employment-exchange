			...
			<main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
				<header class="page-header row justify-center">
					<div class="col-md-6 col-lg-8" >
						<h1 class="float-left text-center text-md-left">Borrado de Alumno</h1>
					</div>
							...
							<div class="col-12">
								<div class="card mb-4">
									...
									<div class="card-block">
                                        <?php
                                            //Borrar alumno de la BD segun su NIA
                                          $nia = $_POST["nia"];
                                          $sql = "DELETE FROM alumnos WHERE NIA=".$nia;
                                          $objetoBBDD->consultarBD($sql);
                                          if($objetoBBDD->filasAfectadas()==1)
                                          {
                                              echo '<div style="color:green;font-weight: bold">Alumno borrado con éxito.</div><br>';
                                          }
                                          else
                                          {
                                              echo '<div style="color:red;font-weight: bold">Hubo un error con el borrado del alumno.</div><br>';
                                          }
                                        echo '<a href="listarAlumnos.php"><button type="submit" class="btn btn-primary btn-md float-right">Volver</button></a>';
                                        ?>
									</div>
								</div>
							</div>
