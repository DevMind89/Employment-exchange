							...
							<div class="col-12">
								<div class="card mb-4">
									...
									<div class="card-block">
                                        <?php
                                            //Listar  NIA,nombre y correo de los alumnos
                                            $sql = "SELECT * FROM alumnos";
                                            $objetoBBDD->consultarBD($sql);

                                            if($fila = $objetoBBDD->devolverFilas()==0)
                                            {
                                                echo '<div style="color:red;font-weight: bold">No se han encontrado alumnos.</div>';
                                            }
                                            else
                                            {
                                                $sql = "SELECT * FROM alumnos";
                                                ...
                                                while($fila = $objetoBBDD->devolverFilas())
                                                {
                                                    ...
                                                    echo'<b><label>NIA: </label></b>&nbsp;';
                                                    echo $fila["NIA"].'&nbsp;&nbsp;';
                                                    echo'<b><label id="nombre">Nombre: </label></b>&nbsp;';
                                                    echo '<a href="listarAlumnoCompleto.php?nia='.$fila["NIA"].'&nombre='.$fila["apellidos_nombre"].'">'.$fila["apellidos_nombre"].'&nbsp;&nbsp;</a>';
