...
<body onload="comprobarCamposVacios();">
        ...
        <main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
            <header class="page-header row justify-center">
                <div class="col-md-6 col-lg-8" >
                    <h1 class="float-left text-center text-md-left">Alta de Empresas</h1>
                </div>
                        ...
                        <div class="col-12">
                            <div class="card mb-4">
                                <div class="card-block">
                                   <!-- Formulario para el alta de empresas-->
                                    <form method="post" id="form" name="form" action="altaEmpresaVerificar.php">
                                        <input type="hidden" name="idEmpresa"  id="idEmpresa">
                                        <label>* Razón Social: </label>
                                        <input type="text" size="15" onchange="comprobarCamposVacios();comprobarCamposNoVacios();" name="razonSocial" id="razonSocial"><br><br>
                                        <label>* Nombre Comercial: </label>
                                        <input type="text" size="21" onchange="comprobarCamposVacios();comprobarCamposNoVacios();" name="nombreComercial" id="nombreComercial">
                                        <label>* CIF: </label>
                                        <input type="text" size="15" onchange="comprobarCamposVacios();comprobarCamposNoVacios();" name="cif" id="cif">
                                        <label>* Dirección: </label>
                                        <input type="text" size="20" onchange="comprobarCamposVacios();comprobarCamposNoVacios();" name="direccion" id="direccion"><br><br>
                                        <label>* Localidad: </label>
                                        <input type="text" size="15" onchange="comprobarCamposVacios();comprobarCamposNoVacios();" name="localidad" id="localidad">
                                        <label>* Provincia: </label>
                                        <input type="text" size="15" onchange="comprobarCamposVacios();comprobarCamposNoVacios();" name="provincia" id="provincia">
                                        <label>* País: </label>
                                        <input type="text" size="15" onchange="comprobarCamposVacios();comprobarCamposNoVacios();" name="pais" id="pais"><br><br>
                                        <label>* Responsable Empresa: </label>
                                        <input type="text" size="15" onchange="comprobarCamposVacios();comprobarCamposNoVacios();" name="responsableEmpresa" id="responsableEmpresa">
                                        <label>Telefono Responsable: </label>
                                        <input type="text" size="15" name="telefonoResponsable" id="telefonoResponsable"><br><br>
                                        <label>* Telefono Empresa: </label>
                                        <input type="text" size="15" onchange="comprobarCamposVacios();comprobarCamposNoVacios();" name="telefonoEmpresa" id="telefonoEmpresa">
                                        <label>* Tipo de Convenio: </label>
                                        <select name="tipoEmpresa" id="tipoEmpresa">
                                            <option value="NoFCT">NoFCT</option>
                                            <option value="FCT">FCT</option>
                                        </select>
                                        <button type="submit"  id="enviar" name="enviar" style="margin-left: 80%;" class="btn btn-primary btn-md float-right">Enviar</button>
