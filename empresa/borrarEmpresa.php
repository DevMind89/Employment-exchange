			...
			<main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
				<header class="page-header row justify-center">
					<div class="col-md-6 col-lg-8" >
						<h1 class="float-left text-center text-md-left">Borrar empresa</h1>
					</div>
								...
								<div class="card mb-4">
									<div class="card-block">
                                        <?php
                                            ...
                                            {
                                                echo '<div style="color:green;font-weight: bold">Éxito al borrar la empresa.</div><br>';
                                            }
                                            else
                                            {
                                                echo '<div style="color:red;font-weight: bold">Error al borrar la empresa.</div><br>';
                                            }
