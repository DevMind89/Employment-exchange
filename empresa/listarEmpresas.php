			...
			<main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
				<header class="page-header row justify-center">
					<div class="col-md-6 col-lg-8" >
						<h1 class="float-left text-center text-md-left">Listado de empresas</h1>
					</div>
							...
							<div class="col-12">
								<div class="card mb-4">
									<div class="card-block">
                                        <?php
                                            //Listar los nombres de las empresas registradas.
                                            $sql = "SELECT idEmpresa,razonSocial FROM empresas ORDER BY razonSocial";
                                            $objetoBBDD->consultarBD($sql);

                                            if($objetoBBDD->devolverFilas()==0)
                                            {
                                                echo '<div style="color:red;font-weight: bold">No se han encontradro empresas registradas.</div>';
                                            }
                                            else
                                            {
                                                $sql = "SELECT idEmpresa,razonSocial FROM empresas ORDER BY razonSocial";
                                                ...
                                                echo'<div class="container">';
                                                    echo'<div class="row">';
                                                        ...
                                                        {
                                                            echo'<div class="col-3 col-sm-3">
                                                                    <form method="post" action="datosEmpresa.php">
                                                                        <label><b>Empresa</b></label><br>
                                                                        <input type="hidden" name="idEmpresa" value="'.$fila["idEmpresa"]. '">
                                                                        <input type="submit"  value="'.$fila["razonSocial"].'" class="btn btn-sm btn-primary"/><br><br>            
                                                                    </form>
                                                                </div>';
                                                        }
                                                    echo'</div>';
