							...
							<div class="col-12">
								<div class="card mb-4">
									<div class="card-block">
                                        ...
                                        <!--Formulario para el alta de formaciones-->
										<form class="form" action="altaFormacionVerificar.php" method="POST">
											<div class="form-group row">
												...
												<div>
													<select class="custom-select form-control" name="tipo">
                                                        ...
                                                        <option value="NoReglada">NoReglada</option>
													</select>
												</div>
                                                <label>&nbsp&nbspCategoria:&nbsp&nbsp</label>
                                                <div>
                                                    <input name="categoria" type="text" class="form-control input-md" placeholder="" />
                                                </div>

                                                <label>&nbsp&nbspSubcategoria:&nbsp&nbsp</label>
                                                <div>
                                                    <input name="subcategoria" type="text" class="form-control input-md" placeholder="" />
                                                </div>
											</div>
                                            <button type="submit" class="btn btn-primary btn-md float-right">Enviar</button>
										</form>
									</div>
								</div>
							</div>
                            <div class="card-block"><p style="color:black"><b>*Aviso</b><br><br>Para la categoria de las actitudes poner el nombre 'Actitudes' sin las comillas
                                    y no cambiarlo al modificar las formaciones</p></div>
						</section>
                    </div>
				</section>
			</main>
