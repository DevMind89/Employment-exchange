			...
			<main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
				<header class="page-header row justify-center">
					<div class="col-md-6 col-lg-8" >
						<h1 class="float-left text-center text-md-left">Alta de formaciones</h1>
					</div>
				...
				<section class="row">
					<div class="col-sm-12">
						<section class="row">
							<div class="col-12">
                                <?php
                                    //Recogida de datos para el alta de formaciones
                                    ...
                                    if(($_POST["tipo"])=="")
                                    {
                                        echo '<div style="color:red;font-weight: bold">Debes elegir un tipo de formación.</div><br>';
                                        echo '<a href="altaFormacion.php"><button type="submit" class="btn btn-primary btn-md float-right">Volver</button></a>';
                                    }
                                    else if(empty($_POST["categoria"]))
                                    {
                                        echo '<div style="color:red;font-weight: bold">Debes poner un nombre para la categoría.</div><br>';
                                        echo '<a href="altaFormacion.php"><button type="submit" class="btn btn-primary btn-md float-right">Volver</button></a>';
                                    }
                                    else if(empty($_POST["subcategoria"]))
                                    {
                                        echo '<div style="color:red;font-weight: bold">Debes poner un nombre para la subcategoría.</div><br>';
                                        echo '<a href="altaFormacion.php"><button type="submit" class="btn btn-primary btn-md float-right">Volver</button></a>';
                                    }
                                    else
                                    {
                                        $sql = "INSERT INTO formacion (idFormacion,tipo,categoria,subcategoria) VALUES (DEFAULT,".$tipo.",".$categoria.",".$subcategoria.");";
                                        $objetoBBDD->consultarBD($sql);

                                        if($objetoBBDD->filasAfectadas()==1)
                                        {
                                            echo '<div style="color:green;font-weight: bold">Éxito al dar de alta la formación.</div><br>';
                                        }
                                        else
                                        {
                                            echo '<div style="color:red;font-weight: bold">Error al dar de alta la formación.</div><br>';
                                        }
										echo '<a href="altaFormacion.php"><button type="submit" class="btn btn-primary btn-md float-right">Volver</button></a>';
                                    }
                                ?>
