			...
			<main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
				<header class="page-header row justify-center">
					<div class="col-md-6 col-lg-8" >
						<h1 class="float-left text-center text-md-left">Borrar formacion</h1>
					</div>
				...
				<section class="row">
					<div class="col-sm-12">
						<section class="row">
							<div class="col-12">
                                <?php
                                    //Borrar la formacion seleccionada
                                    $tipo = $_GET["tipo"];
                                    ...
                                    else
                                    {
                                        echo'<div class="card mb-4">';
                                            echo'<div class="card-block">';
                                                echo'<p style="color:black">¿Estas seguro que deseas borrar la formación <b> '.$tipo.'-->'.$categoria.'-->'.$subcategoria.'</b> ?<br><br>';
                                                echo'<form action="borrarFormacionVerificar.php" method="post">';
                                                    echo'<input type="hidden" name="tipo" value="'.$tipo.'" />';
                                                    echo'<input type="hidden" name="categoria" value="'.$categoria.'" />';
                                                    echo'<input type="hidden" name="subcategoria" value="'.$subcategoria.'" />';
                                                    echo'<button type="submit" name="Si" class="btn btn-primary btn-md ">Si</button>&nbsp';
                                                    echo'<a href="listarFormacion.php"><button type="button" name="No" class="btn btn-primary btn-md ">No</button></a>';
                                                echo'</form>';
                                            echo'</div>';
                                        echo'</div>';
                                    }
