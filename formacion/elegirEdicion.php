<?php
    ...
    $subcategoria = $_COOKIE['subcategoria'];

    if(isset($_POST["modificar"])&& $tipo!=="" && $categoria!=="" && $subcategoria!=="")
    {
        header("Location:modificarFormacion.php?tipo=".$tipo."&categoria=".$categoria."&subcategoria=".$subcategoria);
    }
    elseif(isset($_POST["borrar"])&& $tipo!=="" && $categoria!=="" && $subcategoria!=="")
    {
        header("Location:borrarFormacion.php?tipo=".$tipo."&categoria=".$categoria."&subcategoria=".$subcategoria);
    }
			...
			<main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
				<header class="page-header row justify-center">
					<div class="col-md-6 col-lg-8" >
						<h1 class="float-left text-center text-md-left">Formacion</h1>
					</div>
				...
				<section class="row">
					<div class="col-sm-12">
						<section class="row">
							<div class="col-12">
                                <?php
                                    //Asegurar que se elije una formacion
                                    if($tipo=="")
                                    {
                                        echo '<div style="color:red;font-weight: bold">Debes seleccionar un tipo de formación.</div><br>';
                                        echo '<a href="listarFormacion.php"><button type="submit" class="btn btn-primary btn-md float-right">Volver</button></a>';
                                    }
                                    elseif($categoria=="")
                                    {
                                        echo '<div style="color:red;font-weight: bold">Debes seleccionar una categoría.</div><br>';
                                        echo '<a href="listarFormacion.php"><button type="submit" class="btn btn-primary btn-md float-right">Volver</button></a>';
                                    }
                                    elseif($subcategoria=="")
                                    {
                                        echo '<div style="color:red;font-weight: bold">Debes seleccionar una subcategoría.</div><br>';
                                        echo '<a href="listarFormacion.php"><button type="submit" class="btn btn-primary btn-md float-right">Volver</button></a>';
                                    }
                                ?>
							</div>
