				...
				<section class="row">
					<div class="col-sm-12">
						<section class="row">
							<div class="col-12">
								<div class="card mb-4">
                                    <h3><i>Borrado de oferta</i></h3>
                                    <div class="card-block">
                                        <?php
                                            //Borrado de la oferta
                                            ...
                                            {
                                                echo '<div style="color:green;font-weight: bold">Éxito al borrar la oferta de empleo.</div><br>';
                                            }
                                            else
                                            {
                                                echo '<div style="color:red;font-weight: bold">Error al borrar la oferta de empleo.</div><br>';
                                            }
                                            echo '<a href="listarOfertas.php"><button type="submit" class="btn btn-primary btn-md float-right">Volver</button></a>';
                                        ?>
                                    </div>
								</div>
							</div>
