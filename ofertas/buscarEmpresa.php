							...
							<div class="col-12">
								<div class="card mb-4">
									...
									<div class="card-block">
                                        <form action="altaOfertas.php" method="post">
                                            <label>CIF: </label>
                                            <input type="text" id="cif" name="cif" onchange="comprobarInput();">
                                            <button type="submit" id="buscar" name="buscar" class="btn btn-sm btn-secondary float-right">Buscar</button><br><br>
                                        </form>
									</div>
								</div>
							</div>
