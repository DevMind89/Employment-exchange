				...
				<section class="row">
					<div class="col-sm-12">
						<section class="row">
							<div class="col-12">
								<div class="card mb-4">
                                    <h3><i>Listado de ofertas</i></h3>
									<div class="card-block">
                                        <?php
                                            //Listar datos si existen de las ofertas
                                            $sql = "SELECT * from ofertas order by fechaOferta DESC";
                                            $objetoBBDD->consultarBD($sql);
                                            if($fila = $objetoBBDD->devolverFilas()==0)
                                            {
                                                echo '<div style="color:red;font-weight: bold">No se han encontrado ofertas de empleos.</div>';
                                            }
                                            else
                                            {
                                                $sql = "SELECT * from ofertas order by fechaOferta DESC";
                                                ...
                                                {
                                                    echo'<div class="col-3 col-sm-10">';
                                                    echo'<form method="post" action="#">';
                                                    echo'<b><label>ID: </label></b>&nbsp;';
                                                    echo $fila["idOferta"].'&nbsp;&nbsp;';
                                                    echo'<b><label>Autor: </label></b>&nbsp;';
                                                    echo $fila["autor"].'&nbsp;&nbsp;';
                                                    echo'<b><label>Nombre: </label></b>&nbsp;';
                                                    echo '<a href="listarOfertaCompleto.php?idOferta='.$fila["idOferta"].'">'.$fila["nombre"].'&nbsp;&nbsp;</a>';
                                                    echo'<b><label>Empresa: </label></b>&nbsp;';
                                                    echo $fila["empresa"].'&nbsp;&nbsp;';
                                                    echo'<b><label>Fecha: </label></b>&nbsp;';
                                                    echo $fila["fechaOferta"].'&nbsp;&nbsp;<br><br>';
                                                    echo'</form>';
                                                    echo'</div>';
                                                }
                                                echo'</div>';
